...
const frontendSkills = ['javascript', 'typescript', 'html', 'css', 'sass', 'react', 'nextjs', 'gatsby', 'vue', 'tailwind']
...
const Skills = () => {
  return (
    <section className="w-full flex flex-col mt-8">
      <h2 className="text-gray-300 mb-8 text-lg font-semibold">Skills & Tools</h2>
