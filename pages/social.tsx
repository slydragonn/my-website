...
import { SiGithub as GithubIcon, SiInstagram as InstagramIcon, SiLinkedin as LinkedinIcon, SiMedium as MediumIcon } from 'react-icons/si';
      ...
      <section className="flex flex-col items-center justify-center w-full min-h-[100vh] px-4 sm:px-10">
          ...
          <section className="relative w-full sm:w-[600px] flex justify-center border-r border-r-[#767676] border-t border-t-[#767676] rounded-tr p-4 mt-8">
            ...
            <div className="z-10 relative w-[250px] sm:w-[80%] md:w-[350px] px-4 border-l border-l-[#767676] border-t border-t-[#767676] rounded-tl">
              <SocialItem><GithubIcon /><a className="hover:text-orange-500 transition-all duration-300" target="_blank" href="https://github.com/slydragonn" rel="noreferrer">@slydragonn</a></SocialItem>
              <SocialItem><InstagramIcon /><a className="hover:text-orange-500 transition-all duration-300" target="_blank" href="https://www.instagram.com/sly_dragonn/" rel="noreferrer">@sly_dragonn</a></SocialItem>
              <SocialItem><LinkedinIcon /><a className="hover:text-orange-500 transition-all duration-300" target="_blank" href="https://www.linkedin.com/in/alejolg/" rel="noreferrer">@alejolg</a></SocialItem>
              <SocialItem><MediumIcon /><a className="hover:text-orange-500 transition-all duration-300" target="_blank" href="https://medium.com/@slydragonn" rel="noreferrer">@slydragonn</a></SocialItem>
            </div>
          </section>
